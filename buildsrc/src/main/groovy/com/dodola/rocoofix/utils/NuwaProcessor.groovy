...
//    }
    ...
    public
    static processJar(File hashFile, File jarFile, File patchDir, Map map, HashSet<String> includePackage, HashSet<String> excludeClass, HashSet<String> excludePackage) {
        if (jarFile) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                if (shouldProcessClassInJar(entryName, includePackage, excludeClass, excludePackage)) {
    ...
    private
    static boolean shouldProcessClassInJar(String entryName, HashSet<String> includePackage, HashSet<String> excludeClass, HashSet<String> excludePackage) {
        return entryName.endsWith(".class") &&
                !entryName.startsWith("com/dodola/rocoofix/") &&
                !entryName.startsWith("com/lody/legend/") &&
                !entryName.matches('\\S*R[\\$]?[a-zA-Z]*\\.class') &&
                ...
                !NuwaSetUtils.isExcludedInPackage(entryName, excludePackage)
    }
